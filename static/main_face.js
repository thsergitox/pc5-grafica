...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const occluder = await loadGLTF('/static/assets/models/sparkar-occluder/headOccluder.glb');
    ...
    const glasses2 = await loadGLTF('/static/assets/models/glasses2/scene.gltf');
    ...
    const hat1 = await loadGLTF('/static/assets/models/hat1/scene.gltf');
    ...
    const hat2 = await loadGLTF('/static/assets/models/hat2/scene.gltf');
    ...
    const earringLeft = await loadGLTF('/static/assets/models/earring/scene.gltf');
    ...
    const earringRight = await loadGLTF('/static/assets/models/earring/scene.gltf');
